<script setup lang="ts">
    ...
    const isOpenModalToCreate = ref<boolean>(false)
    ...
    async function handleCreateAct(this: any) {
        try{
...
<template>
    <div class="mainContainer">
        ...
        <CustomModal 
        v-if="isOpenModalToCreate" 
        @close="()=>{isOpenModalToCreate = !isOpenModalToCreate}"
        >
            <template v-slot:text>
                ...
                <form class="createForm" @submit.prevent="handleCreateAct">
                    ...
                    <div class="buttonContainer">
                        <button class="button cancel" @click="()=>{isOpenModalToCreate = !isOpenModalToCreate}">
                            Cancelar
                        </button>
        ...
        <span v-if="!loading" class="buttonContainer">
            <button class="addNew" @click="()=>{isOpenModalToCreate = !isOpenModalToCreate}">Adicionar novo ato</button>
            <button class="addNew" @click="()=> {console.log(`novo CAP`)}">Adicionar novo capítulo</button>
        </span>
